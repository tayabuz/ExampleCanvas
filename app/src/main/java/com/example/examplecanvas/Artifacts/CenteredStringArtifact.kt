...
class CenteredStringArtifact(rect: Rect, text: String, typefaceFont: Typeface, colorForText: Int) :
    FittedInRectStringArtifact(rect, text, typefaceFont, colorForText) {
